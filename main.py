...
if __name__ == "__main__":
    ...
    for i in range(1, 8):
        try:
            print(str(i) + ": " + str(subgoals_no_empty[i]))
        except KeyError:
            ()
    exit()
