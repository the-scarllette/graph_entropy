...
<img src="environment_images/simplecrafter-example.png" alt="SimpleCrafter Environment Example" width="300"/>
...
| $n^{2} + 4$                 | **Wood Pickaxe:** Is $0$ if the agent does not have a wood pickaxes,<br/>and $1$ if they do.                                               |
| $n^{2} + 5$                 | **Stone Pickaxe:** Is $0$ if the agent does not have a stone pickaxes,<br/>and $1$ if they do.                                             |
| $n^{2} + 6$                 | **Iron Pickaxe:** Is $0$ if the agent does not have an iron pickaxes,<br/>and $1$ if they do.                                              |
...
| Collect: $4$         | Collect the resources in all squared adjacent to the agent.<br/>To collect stone a wood pickaxe is required,<br/>to collect iron a stone pickaxe is required,<br/>and to collect diamond an iron pickaxe is required.<br/>Has no effect if no adjacent resources can be collected. |
...
Each timestep the agent moves, collects resources, and crafts equipment.
